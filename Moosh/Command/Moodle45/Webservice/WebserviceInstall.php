...
namespace Moosh\Command\Moodle45\Webservice;
...
class WebserviceInstall extends MooshCommand
{
    ...
    public function execute()
    {
        ...
        // Take admin role
        // Generate Token.
        $token = \core_external\util::generate_token(EXTERNAL_TOKEN_PERMANENT, $service, $wsuserid, $systemcontext, $validuntil, $iprestriction);
