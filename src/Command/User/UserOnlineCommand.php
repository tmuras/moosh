...
class UserOnlineCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ->setName('user:online')
            ->setDescription('Show currently online users')
            ->setHelp(<<<'HELP'
                Lists users who have been active within a recent time window.

                Examples:
                  user:online
                  user:online --time 300
                  user:online --limit 10
                  user:online -o csv
                HELP);
