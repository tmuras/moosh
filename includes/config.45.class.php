...
The server URL to connect to for sending push notifications.
     ...
     *
     * @var string allcomponenthash 
     */
    public $allcomponenthash;
...
This determines whether to allow search engines to index your site. "Everywhere" will allow the search engines to search everywhere including login and signup pages, which means sites with Force Login turned on are still indexed. To avoid the risk of spam involved with the signup page being searchable, use "Everywhere except login and signup pages". "Nowhere" will tell search engines not to index any page. Note this is only a tag in the header of the site. It is up to the search engine to respect the tag.
    ...
    /**
For security, users with the role of student are not allowed to embed multimedia within texts using EMBED and OBJECT tags in HTML, though multimedia can still be displayed using the multimedia plugins filter. If you wish to allow these tags then enable this option.
     *
...
Leave empty if using a DSN name in database host.
     ...
     *
     * @var string behat_frozen_clock 
     */
    public $behat_frozen_clock;
...
The above prefix gets used for all keys being stored in this APC store instance. By default the database prefix is used.
     ...
     *
     * @var string bigbluebuttonbn_recordings_asc_sort 
     */
    public $bigbluebuttonbn_recordings_asc_sort;
...
This setting allows you to control who appears on the course description. Users need to have at least one of these roles in a course to be shown on the course description for that course.
    ...
    /**
Defines the path to a Quickstart guide with short videos and general tips to create courses. A link to the guide is displayed on the My courses page when there are no courses to show. Only users with the capability to create courses will see the link.
     *
     * @var string coursecreationguide Moodle course creation guide URL
     */
    public $coursecreationguide;
...
If you turn this on, then PHP\'s error_reporting will be increased so that more warnings are printed.  This is only useful for developers.
     ...
     *
     * @var string debug_developer_debugging_as_error 
     */
    public $debug_developer_debugging_as_error;

    /**

     *
     * @var string debug_developer_editor 
     */
    public $debug_developer_editor;

    /**

     *
     * @var string debug_developer_use_pretty_exceptions 
     */
    public $debug_developer_use_pretty_exceptions;
...
If enabled, language string components and identifiers are displayed when ?strings=1 or &strings=1 is appended to the page URL.
    ...
    /**
If enabled, templates used for rendering are shown as comments in the page HTML. After changing the setting, you need to purge caches. Use for temporary debugging only, as it produces HTML validation errors and can break page scripts. It can also break core functionality!
     *
     * @var string debugtemplateinfo Show template information
     */
    public $debugtemplateinfo;
...
This language will be used in links for the documentation pages.
    ...
    /**
Defines the path to Moodle Docs for providing context-specific documentation via \'Documentation for this page\' links in the footer of each page. If the field is left blank, links will not be displayed.
     *
...
Analytics models, such as \'Students at risk of dropping out\' or \'Upcoming activities due\', can generate predictions, send insight notifications and offer further actions such as messaging users.
    ...
    /**
If enabled, backup and restore operations will be done asynchronously. This provides a better user experience allowing users to do other operations while a backup or restore is in progress. This does not affect imports and exports.
     *
...
Enable exporting or subscribing to calendars.
    ...
    /**
If enabled, you can set conditions for activity completion or course completion.
     *
...
When enabled Moodle will attempt to fetch a user profile picture from Gravatar if the user has not uploaded an image.
     ...
     *
     * @var string enableloginrecaptcha 
     */
    public $enableloginrecaptcha;
...
If enabled, grade items may be graded using one or more scales tied to outcome statements.
    ...
    /**
If your site has courses in different languages which need other fonts in generated PDF files, you can provide the option to set the font in the course settings. You need to specify available fonts in $CFG->pdfexportfont in config.php.
     *
     * @var string enablepdfexportfont Enable PDF fonts
     */
    public $enablepdfexportfont;
...
If enabled, RSS feeds are generated by various features across the site, such as blogs, forums, database activities and glossaries. Note that RSS feeds also need to be enabled for the particular activity modules.
    ...
    /**
Enable users to share course content to a configured MoodleNet instance if they have the relevant capability.
     *
     * @var string enablesharingtomoodlenet Enable sharing to MoodleNet (outbound)
     */
    public $enablesharingtomoodlenet;
...
This setting forces people to log in as a real (non-guest) account before viewing any user\'s profile. If you disabled this setting, you may find that some users post advertising (spam) or other inappropriate content in their profiles, which is then visible to the whole world.
     ...
     *
     * @var string forum_announcementmaxattachments 
     */
    public $forum_announcementmaxattachments;

    /**

     *
     * @var string forum_announcementsubscription 
     */
    public $forum_announcementsubscription;
...
For most mono-lingual sites the most efficient setting is "firstname lastname", but you may choose to hide last names altogether. Placeholders that can be used are: firstname, lastname, firstnamephonetic, lastnamephonetic, middlename, and alternatename.
    ...
    /**
Select the edition of the GeoIP database to download. Please be aware that using the GeoIP2-City database requires a valid paid license.
     *
     * @var string geoipdbedition GeoIP Database Edition
     */
    public $geoipdbedition;

    /**
The account ID of the account created on the MaxMind API service.
     *
     * @var string geoipmaxmindaccid MaxMind account ID
     */
    public $geoipmaxmindaccid;

    /**
The license key of the account created on the MaxMind API service.
     *
     * @var string geoipmaxmindlicensekey MaxMind license key
     */
    public $geoipmaxmindlicensekey;
...
If set, this feedback method will be enabled by default for all new assignments.
     *
     * @var string gradeexport_default Default
     */
    public $gradeexport_default;
...
Select which user information fields you wish to hide from other users other than course teachers/admins. This will increase student privacy. Hold CTRL key to select multiple fields.
     ...
     *
     * @var string hooks_callback_overrides 
     */
    public $hooks_callback_overrides;
...
Read notifications can be deleted to save space. How long after a notification is read can it be deleted?
     ...
     *
     * @var string mfa_config_hook_test 
     */
    public $mfa_config_hook_test;
...
If enabled, any hidden courses will be listed after visible courses (for users who can view hidden courses). Otherwise, all courses, regardless of their visibility, will be listed according to the \'Sort my courses\' setting.
    ...
    /**
Should courses be listed in the sort order set in Site administration > Courses > Manage courses and categories, or alphabetically by course setting? This setting only applies to themes based on Classic.
     *
     * @var string navsortmycoursessort Order of courses in navigation block
     */
...
If enabled, when a password is changed, all the user web service access tokens are deleted.
     ...
     *
     * @var string passwordpeppers 
     */
    public $passwordpeppers;
...
Path to unoconv document converter. This is an executable that is capable of converting between document formats supported by LibreOffice. This is optional, but if specified, Moodle will use it to automatically convert between document formats. This is used to support a wider range of input files for the assignment annotate PDF feature.
    ...
    /**
The font to be used for generated PDF files, such as assignment submissions.
     *
     * @var string pdfexportfont PDF font
     */
...
By setting a minimum time in seconds all pages slower will be profiled. Only profiles which are slower than an existing profile for the same script will be kept. Set to 0 to disable. Note that this observes the exclude settings.
     ...
     *
     * @var string progresspollinterval 
     */
    public $progresspollinterval;
...
Username needed to access internet through proxy if required, empty if none (PHP cURL extension required).
    ...
    /**
Whether question options such as \'Default mark\', \'One or multiple answers?\' etc. should be saved as user preferences when the edit question form is submitted, for use as defaults the next time the user accesses the form.
     *
     * @var string questiondefaultssave Save question options as user preference defaults
     */
    public $questiondefaultssave;
...
If your server is behind multiple reverse proxies that append to the X-Forwarded-For header, then specify a comma-separated list of IP addresses or subnets of the reverse proxies to be ignored in order to find the user\'s correct IP address.
     ...
     *
     * @var string router_configured 
     */
    public $router_configured;

    /**

     *
     * @var string routerconfigured 
     */
...
If enabled, the text below will be displayed at the top of the search screen for all users. This can be used to inform users when search engine maintenance is being carried out.
    ...
    /**
Results from the selected search area category will be displayed by default.
     *
     * @var string searchdefaultcategory Default search category
     */
    public $searchdefaultcategory;

    /**
If enabled, search results will be displayed in separate categories.
     *
     * @var string searchenablecategories Display results in separate categories
     */
    public $searchenablecategories;
...
This search engine will be used only for making queries, not indexing. By using this feature you can reindex in a different search engine, while user queries continue to work from this one.
    ...
    /**
If checked, the category with all results will be hidden on the search result screen.
     *
     * @var string searchhideallcategory Hide All results category
     */
    public $searchhideallcategory;
...
Allows the scheduled task to build the search index even when search is disabled. This is useful if you want to build the index before the search facility appears to students.
    ...
    /**
The maximum number of highest-ranked results to be displayed above the search results for course content, courses and users.
     *
     * @var string searchmaxtopresults Maximum top results
     */
    public $searchmaxtopresults;
    ...
    /**
Enter the URL of a services and support page or leave empty to link to Moodle services on moodle.com. The link is only displayed for site administrators.
     *
     * @var string servicespage Services and support link
     */
    public $servicespage;
     ...
     *
     * @var string session_redis_encrypt 
     */
    public $session_redis_encrypt;
...
This setting customises the name of the cookie used for Moodle sessions.  This is optional, and only useful to avoid cookies being confused when there is more than one copy of Moodle running within the same web site.
     *
     * @var string sessioncookie Cookie suffix
     */
...
This setting specifies the default charset for all emails sent from the site.
    ...
    /**
This setting will append the site name at the end of the page title. It is encouraged to include the site name in the page title as it will improve the site\'s accessibility by allowing users to quickly identify the page that they are currently in.
     *
     * @var string sitenameintitle Include site name in page title
     */
    public $sitenameintitle;
...
The name of the person or other entity providing support via the support form or support page.
    ...
    /**
Enter the URL of a support page or leave empty to link to a contact form. The link is displayed in the site footer.
     *
     * @var string supportpage Contact site support link
     */
    public $supportpage;
    ...
    /**
The maximum period that failed ad hoc tasks should remain in the queue once they have reached their retry limit.
     *
     * @var string task_adhoc_failed_retention Failed ad hoc task retention period
     */
    public $task_adhoc_failed_retention;
...
When jobs are running and the output is captured, whether the captured output should also be displayed as the task runs.
     ...
     *
     * @var string taskruntimeerror 
     */
    public $taskruntimeerror;

    /**

     *
     * @var string taskruntimewarn 
     */
    public $taskruntimewarn;
...
Publication date of the licence version being utilised.
    ...
    /**
Remove any stored xAPI which is not updaded in the selected period
     *
     * @var string xapicleanupperiod Clean up xAPI states
     */
    public $xapicleanupperiod;
