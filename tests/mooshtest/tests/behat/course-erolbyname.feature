...
Feature: The command course-enrolbyname enrol existing user to existing course.
  ...
  erol two user to the course
    ...
    And the following "courses" exist:
      | fullname | shortname | category |
      | Course 1 | C1        | 0        |
    When I run moosh "course-enrolbyname -f Teacher -l 1 %shortname:C1%"
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to course participants
    Then I should see "Teacher 1" in the "participants" "table"
  ...
  erol two user to the course
    ...
    And the following "courses" exist:
      | fullname | shortname | category |
      | Course 1 | C1        | 0        |
    When I run moosh "course-enrolbyname -l 1 -f Teacher %shortname:C1%"
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to course participants
    Then I should see "Teacher 1" in the "participants" "table"
  ...
  erol the user to the course as a teacher.
    ...
    And the following "courses" exist:
      | fullname | shortname | category |
      | Course 1 | C1        | 0        |
    When I run moosh "course-enrolbyname -r teacher -l 1 -f Teacher %shortname:C1%"
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to course participants
    Then I should see "Teacher 1" in the "participants" "table"
  ...
  erol the user to the course
    ...
    And the following "courses" exist:
      | fullname | shortname | category |
      | Course 1 | C1        | 0        |
    When I run moosh "course-enrolbyname -c C1 "
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to course participants
    Then I should see "Teacher 1" in the "participants" "table"
